...
-- 插入2024年11月的财务记录数据
INSERT INTO finance_record (store_id, type, amount, category_id, record_date, remark) VALUES
-- 11月上旬收入记录 (store_id = 1)
(1, 'income', 5200.00, 1, '2024-11-01', '日常销售'),
(1, 'income', 5800.00, 1, '2024-11-03', '周末销售'),
(1, 'income', 5500.00, 1, '2024-11-05', '日常销售'),
(1, 'income', 250.00, 2, '2024-11-06', '废品回收'),
(1, 'income', 6200.00, 1, '2024-11-08', '促销活动'),
(1, 'income', 5900.00, 1, '2024-11-10', '日常销售'),

-- 11月上旬支出记录 (store_id = 1)
(1, 'expense', 3500.00, 3, '2024-11-02', '日常进货'),
(1, 'expense', 4500.00, 4, '2024-11-05', '员工工资'),
(1, 'expense', 850.00, 5, '2024-11-05', '11月水电费'),
(1, 'expense', 2000.00, 6, '2024-11-05', '11月房租'),
(1, 'expense', 300.00, 7, '2024-11-07', '清洁用品'),
(1, 'expense', 2800.00, 3, '2024-11-09', '补充库存'),

-- 11月中旬收入记录 (store_id = 1)
(1, 'income', 5600.00, 1, '2024-11-11', '日常销售'),
(1, 'income', 5900.00, 1, '2024-11-13', '日常销售'),
(1, 'income', 7500.00, 1, '2024-11-15', '双11促销'),
(1, 'income', 200.00, 2, '2024-11-16', '废品回收'),
(1, 'income', 5800.00, 1, '2024-11-18', '日常销售'),
(1, 'income', 5500.00, 1, '2024-11-20', '日常销售'),

-- 11月中旬支出记录 (store_id = 1)
(1, 'expense', 4000.00, 3, '2024-11-12', '双11备货'),
(1, 'expense', 500.00, 7, '2024-11-14', '促销装饰'),
(1, 'expense', 2500.00, 3, '2024-11-16', '补充库存'),
(1, 'expense', 200.00, 7, '2024-11-18', '办公用品'),

-- 11月下旬收入记录 (store_id = 1)
(1, 'income', 5400.00, 1, '2024-11-21', '日常销售'),
(1, 'income', 5700.00, 1, '2024-11-23', '周末销售'),
(1, 'income', 5300.00, 1, '2024-11-25', '日常销售'),
(1, 'income', 5800.00, 1, '2024-11-27', '日常销售'),
(1, 'income', 6000.00, 1, '2024-11-29', '月末促销'),
(1, 'income', 300.00, 2, '2024-11-30', '废品回收'),

-- 11月下旬支出记录 (store_id = 1)
(1, 'expense', 3000.00, 3, '2024-11-22', '日常进货'),
(1, 'expense', 2500.00, 3, '2024-11-26', '补充库存'),
(1, 'expense', 400.00, 7, '2024-11-28', '其他支出'),

-- store_id = 2 的11月记录
(2, 'income', 4200.00, 1, '2024-11-01', '日常销售'),
(2, 'income', 4500.00, 1, '2024-11-05', '日常销售'),
(2, 'income', 5500.00, 1, '2024-11-15', '双11促销'),
(2, 'income', 4300.00, 1, '2024-11-20', '日常销售'),
(2, 'income', 4600.00, 1, '2024-11-25', '日常销售'),
(2, 'income', 200.00, 2, '2024-11-30', '废品回收'),

(2, 'expense', 2500.00, 3, '2024-11-02', '日常进货'),
(2, 'expense', 3500.00, 4, '2024-11-05', '员工工资'),
(2, 'expense', 600.00, 5, '2024-11-05', '11月水电费'),
(2, 'expense', 1500.00, 6, '2024-11-05', '11月房租'),
(2, 'expense', 3000.00, 3, '2024-11-12', '双11备货'),
(2, 'expense', 2000.00, 3, '2024-11-25', '补充库存');